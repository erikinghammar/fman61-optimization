...
disp("     " + string(N_itr) + blanks(11 - strlength(string(N_itr))) ...
    + string(x_itr(1)) + blanks(14 - strlength(string(x_itr(1)))) ...
    + string(fx) + blanks(13 - strlength(string(fx))) ...
    + string(n_grad) + blanks(17 - strlength(string(n_grad))) ...
    + string(ls_fun_evals) + blanks(11 - strlength(string(ls_fun_evals))) ...
    + string(lambda))
for i = 2:length(x_itr)
    disp(blanks(16) + string(x_itr(i))) 
end
